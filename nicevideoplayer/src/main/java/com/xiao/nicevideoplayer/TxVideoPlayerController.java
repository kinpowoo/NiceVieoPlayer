...
public class TxVideoPlayerController
    ...
    private void init() {
        ...
        errorBack = (ImageView) findViewById(R.id.play_error_back);
        mRetry = (TextView) findViewById(R.id.retry);

        mCompleted = (RelativeLayout) findViewById(R.id.completed);
        mCompletedBack = (ImageView) findViewById(R.id.play_finish_back);
        ...
        mCompletedBack.setOnClickListener(this);
    ...
    protected void onPlayModeChanged(int playMode) {
        switch (playMode) {
            case NiceVideoPlayer.MODE_NORMAL:
                ...
                mCompletedBack.setVisibility(GONE);
                errorBack.setVisibility(GONE);
                break;
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            mRetry.performClick();
        } else if(v == mCompletedBack || v == errorBack){
            if (mNiceVideoPlayer.isFullScreen()) {
                mNiceVideoPlayer.exitFullScreen();
            } else if (mNiceVideoPlayer.isTinyWindow()) {
                mNiceVideoPlayer.exitTinyWindow();
